...
int main()
{
  try
  {
    ...
    ///////////////////////// TO-DO (2) //////////////////////////////
      ...
      ///
    auto shoppingCarts = myBookstore.makeShoppingCarts();
    /////////////////////// END-TO-DO (2) ////////////////////////////


    ///////////////////////// TO-DO (3) //////////////////////////////
      /// There are several shoppers standing in line waiting to purchase the books in their shopping cart.  Process them all by
      /// passing the collection of shopping carts to your store's ringUpCustomers function.  This function will, for
      ...
      ///
    auto todaysSales = myBookstore.ringUpCustomers( shoppingCarts );
    /////////////////////// END-TO-DO (3) ////////////////////////////
    ...
    ///////////////////////// TO-DO (4) //////////////////////////////
      ...
      /// inventory.
      ///
    auto & inventory = myBookstore.inventory();
    ...
    myBookstore.reorderItems( todaysSales );
    /////////////////////// END-TO-DO (5) ////////////////////////////
  }

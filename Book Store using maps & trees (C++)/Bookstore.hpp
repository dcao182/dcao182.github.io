...
class Bookstore
{
  public:
    ...
    using ShoppingCarts = std::map<std::string /*name*/, ShoppingCart             >;  // A collection of shoppers, identified by
    ...
    BooksSold ringUpCustomers( const ShoppingCarts & shoppingCarts );

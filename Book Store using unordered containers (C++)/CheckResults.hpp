...
namespace Regression
{
  ...
  template<typename T, typename U>
  bool CheckResults::is_less_than( const std::string & nameOfTest, const T & lhs, const U & rhs )
  {
    ++testCount;
    ...
    {
      ++testsPassed;
      testResults << "  [PASSED] " << nameOfTest << ": left hand side '" << lhs << "' is less than the right hand side '" << rhs << "'\n";
    }
    else
    {
      testResults << " *[FAILED] " << nameOfTest << ": left hand side '" << lhs << "' is not less than the right hand side '" << rhs << "'\n";
    }
  ...
  template<typename T, typename U>
  bool CheckResults::is_greater_than( const std::string & nameOfTest, const T & lhs, const U & rhs )
  {
    ++testCount;
    ...
    {
      ++testsPassed;
      testResults << "  [PASSED] " << nameOfTest << ": left hand side '" << lhs << "' is greater than the right hand side '" << rhs << "'\n";
    }
    else
    {
      testResults << " *[FAILED] " << nameOfTest << ": left hand side '" << lhs << "' is not greater than the right hand side '" << rhs << "'\n";
    }

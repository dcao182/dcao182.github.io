...
class BookList
{
  ...
  public:
   ...
   ~BookList();
    ...
    int compare( const BookList & other ) const;                                              // returns a negative number if this book list is less than the other book
                                                                                              // list, zero if this book list is equal to the other book list, and a
                                                                                              // positive number if this book list is greater than the other book list.
